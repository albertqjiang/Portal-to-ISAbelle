...
case class ProofText(text: String)
case class logProbs(tokens: List[String], token_logprobs: List[Double])

class PisaSearch(use_proof: Boolean = false, use_conjecture: Boolean = false, use_state_first: Boolean = false,
...
//  val replacements = Map("/home/ywu/afp-2021-02-11/".r -> "/home/ywu/afp-2021-02-11/")
  ...
  def main(args: Array[String]): Unit = {
    ...
    val search_agent = new PisaSearch(use_proof=use_proof, use_conjecture=use_conj,
