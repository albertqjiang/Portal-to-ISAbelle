...
if __name__ == "__main__":
    ...
    file_path = input("Path to an AFP file (default /home/qj213/afp-2021-10-22/thys/FunWithFunctions/FunWithFunctions.thy): ")
    file_path = "/home/qj213/afp-2021-10-22/thys/FunWithFunctions/FunWithFunctions.thy" if not file_path else file_path.strip()
    env = IsaFlexEnv(
