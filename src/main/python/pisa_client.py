...
if __name__ == '__main__':
    ...
    print("First hammer result: " + env.step_to_top_level_state('normalhammer', 'test', 'test1'))
    print(env.step_to_top_level_state('let ?N = "(\<Prod>p \<in> p. p) + 1" have "prime ?N \<Longrightarrow> \<not> (finite {(p::nat). prime p})"', 'test1', 'test'))
    print("Second hammer result: " + env.step_to_top_level_state('normalhammer', 'test', 'test1'))
